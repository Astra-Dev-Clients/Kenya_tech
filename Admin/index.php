                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    ...
                                    <button class="au-btn au-btn-icon au-btn--blue"  onclick="window.location='add_event.php'"  data-bs-target="#addProductModal">
                                        <i class="zmdi zmdi-plus"  data-bs-toggle="modal" ></i>add Event</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © 2025 Astrasoftwares. All rights reserved.<a href="https://astrasoft.tech">Astra Softwares</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
